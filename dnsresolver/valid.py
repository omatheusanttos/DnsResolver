...
def scan_ip_and_save(ip_address):
    """
    Pesquisa um IP no Censys Search API usando o SDK 'censys'.
    """
    
    # 1. Inicializa o cliente CensysHosts
    try:
        # O SDK 'censys' aceita a chave no parâmetro 'api_secret'
        c = CensysHosts(api_secret=CENSYS_PAT) 
    ...
    try:
        # O método .view() é perfeito para obter o documento completo do IP
...
if __name__ == "__main__":
    ...
    # Verificação simples para dar feedback imediato
    try:
